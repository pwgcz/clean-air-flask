...
def post_begin():
    ...
    if hasattr(exc, "RemovedIn20Warning"):
        warnings.filterwarnings(
            "error", category=exc.RemovedIn20Warning, message=".*Engine.execute",
        )
        warnings.filterwarnings(
            "error", category=exc.RemovedIn20Warning, message=".*Passing a string",
        )
...
def _init_symbols(options, file_config):
    ...
    config._fixture_functions = alembic_config._fixture_functions = _fixture_fn_class()
